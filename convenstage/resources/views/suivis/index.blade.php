                        ...
                        <div class="row justify-content-center mb-3">
                            <div class="col-md-12">
                                <form class="form-group">
                                    <input type="text" name="search" @if(Auth::user()->role == 'tuteur') id="search-suivis-tuteur" @else id="search-suivis" @endif class="form-control" value="" placeholder="Recherche d'utilisateur">
                                </form>
                                        ...
                                        <div class="card mt-3">
                                            <div class="card-body" style="cursor: pointer;" onclick="window.location='{{ route('suivis.show', $suivi->user_id) }}';">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-1">
                                                        @if(!(Auth::user()->role == 'secretaire' || Auth::user()->role == 'tuteur'))
